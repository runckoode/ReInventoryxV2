...
public class PanelClientes extends JPanel {
	...
	public PanelClientes() {
		...
		lblControlDeClientes.setFont(FONT_PANEL_TITLE);
		lblControlDeClientes.setForeground(COLOR_TEXT_NEGRO);
		lblControlDeClientes.setHorizontalAlignment(SwingConstants.CENTER);
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.gridwidth = 4;
		...
		panelContenido.add(lblControlDeClientes, gbc);
		gbc.gridwidth = 1;
		...
		styleLabel(lblNombreCliente);
		panelContenido.add(lblNombreCliente, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textNombre = new JTextField(20);
		styleTextField(textNombre, true, "Nombre del cliente");
		...
		styleLabel(lblApellidoCliente);
		panelContenido.add(lblApellidoCliente, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textApellido = new JTextField(20);
		styleTextField(textApellido, true, "Apellido del cliente");
		panelContenido.add(textApellido, gbc);
		gbc.fill = GridBagConstraints.NONE;

		gbc.gridy = 4;
		gbc.gridx = 0;
		JLabel lblTelefonoCliente = new JLabel("Teléfono:");
		styleLabel(lblTelefonoCliente);
		panelContenido.add(lblTelefonoCliente, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textTelefono = new JTextField(20);
		styleTextField(textTelefono, true, "Número de teléfono");
		panelContenido.add(textTelefono, gbc);
		gbc.fill = GridBagConstraints.NONE;

		gbc.gridy = 5;
		gbc.gridx = 0;
		JLabel lblEmailCliente = new JLabel("Email:");
		styleLabel(lblEmailCliente);
		panelContenido.add(lblEmailCliente, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textEmail = new JTextField(20);
		styleTextField(textEmail, true, "correo@ejemplo.com");
		panelContenido.add(textEmail, gbc);
		gbc.fill = GridBagConstraints.NONE;
