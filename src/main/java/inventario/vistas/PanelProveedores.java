...
public class PanelProveedores extends JPanel {
	...
	public PanelProveedores() {
		...
		lblControlDeProveedores.setFont(FONT_PANEL_TITLE);
		lblControlDeProveedores.setForeground(COLOR_TEXT_NEGRO);
		lblControlDeProveedores.setHorizontalAlignment(SwingConstants.CENTER);
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.gridwidth = 4;
		...
		panelContenido.add(lblControlDeProveedores, gbc);
		gbc.gridwidth = 1;
		...
		styleLabel(lblNombreProveedor);
		panelContenido.add(lblNombreProveedor, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textNombre = new JTextField(20);
		styleTextField(textNombre, true, "Nombre del proveedor");
		panelContenido.add(textNombre, gbc);
		gbc.fill = GridBagConstraints.NONE;

		gbc.gridy = 3;
		gbc.gridx = 0;
		JLabel lblApellidoProveedor = new JLabel("Apellido/Contacto:");
		styleLabel(lblApellidoProveedor);
		panelContenido.add(lblApellidoProveedor, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textApellido = new JTextField(20);
		styleTextField(textApellido, true, "Apellido o persona de contacto");
		panelContenido.add(textApellido, gbc);
		gbc.fill = GridBagConstraints.NONE;

		gbc.gridy = 4;
		gbc.gridx = 0;
		JLabel lblCelularProveedor = new JLabel("Celular:");
		styleLabel(lblCelularProveedor);
		panelContenido.add(lblCelularProveedor, gbc);

		gbc.gridx = 1;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		textCelular = new JTextField(20);
		styleTextField(textCelular, true, "Número de celular");
		panelContenido.add(textCelular, gbc);
		gbc.fill = GridBagConstraints.NONE;
		...
		gbcBotones.gridx = 1; gbcBotones.gridy = 0; panelBotones.add(btnBuscar, gbcBotones);

		btnEditar = new JButton("Editar");
		styleButton(btnEditar);
		btnEditar.setIcon(IconFontSwing.buildIcon(FontAwesomeSolid.PEN, 15, COLOR_TEXT_NEGRO));
		gbcBotones.gridx = 0; gbcBotones.gridy = 1; panelBotones.add(btnEditar, gbcBotones);
		...
		tablaProveedores.getColumnModel().getColumn(2).setPreferredWidth(180);
		tablaProveedores.getColumnModel().getColumn(3).setPreferredWidth(120);
